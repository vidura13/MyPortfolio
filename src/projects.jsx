export const projects = [
...

  {
    ...
    link: "#",
    longDescription:
      "This solution is an attempt to manage our daily expenses in a more efficient and manageable way. The application allows users to eliminate any unnecessary expenses and keep track of their spendings and help them make better financial decisions. This attempts to free the user as much as possible from the burden of manual calculation and keep the track of the expenses in real time.",
    functionalities: [
